...
(function(exports) {
  ...
  var view = function (action) {
      return function (state) {
          return PrestoDOM_Elements.linearLayout([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.Match_Parent.value), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.Match_Parent.value), PrestoDOM_Properties.background("#323232"), PrestoDOM_Properties.gravity("center"), PrestoDOM_Properties.name("rootNode") ])([ PrestoDOM_Elements.linearLayout([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(600)), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(400)), PrestoDOM_Properties.background("#000000"), PrestoDOM_Properties.orientation("vertical"), PrestoDOM_Properties.gravity("center") ])([ PrestoDOM_Elements.linearLayout([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(150)), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.Match_Parent.value), PrestoDOM_Properties.orientation("vertical"), PrestoDOM_Properties.margin("20,20,20,20") ])([ PrestoDOM_Elements.linearLayout([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(30)), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.Match_Parent.value), PrestoDOM_Properties.margin("10,20,20,20"), PrestoDOM_Properties.text("Login"), PrestoDOM_Properties.textSize("28") ])([  ]), PrestoDOM_Elements.linearLayout([  ])([ PrestoDOM_Elements.editText([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(40)), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.Match_Parent.value), PrestoDOM_Properties.margin("10,10,10,10"), PrestoDOM_Properties.textSize("20"), PrestoDOM_Properties.name("name"), PrestoDOM_Events.onChange(action.loginTextChange) ]) ]) ]), PrestoDOM_Elements.linearLayout([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(150)), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.Match_Parent.value), PrestoDOM_Properties.orientation("vertical"), PrestoDOM_Properties.margin("20,0,20,0") ])([ PrestoDOM_Elements.linearLayout([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(30)), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.Match_Parent.value), PrestoDOM_Properties.margin("10,20,20,20"), PrestoDOM_Properties.text("Password"), PrestoDOM_Properties.textSize("28") ])([  ]), PrestoDOM_Elements.linearLayout([  ])([ PrestoDOM_Elements.editText([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(40)), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.Match_Parent.value), PrestoDOM_Properties.margin("10,10,10,10"), PrestoDOM_Properties.textSize("20"), PrestoDOM_Properties.name("name"), PrestoDOM_Properties.color("#00000"), PrestoDOM_Events.onChange(action.passTextChange) ]) ]) ]), PrestoDOM_Elements.linearLayout([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(150)), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.Match_Parent.value), PrestoDOM_Properties.orientation("vertical"), PrestoDOM_Properties.margin("20,20,20,20"), PrestoDOM_Properties.gravity("center") ])([ PrestoDOM_Elements.linearLayout([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(50)), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.Match_Parent.value), PrestoDOM_Properties.margin("20,0,20,0") ])([ PrestoDOM_Elements.linearLayout((function () {
              if (state.success) {
                  return [ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.Match_Parent.value), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.Match_Parent.value), PrestoDOM_Properties.text(state.errorMsg), PrestoDOM_Properties.visibility(state.visibility), PrestoDOM_Properties.margin("20,20,20,20"), PrestoDOM_Properties.textSize("20") ];
              };
              if (!state.success) {
                  return [ PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.Match_Parent.value), PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.Match_Parent.value), PrestoDOM_Properties.margin("20,20,20,20"), PrestoDOM_Properties.text(state.errorMsg), PrestoDOM_Properties.visibility(state.visibility), PrestoDOM_Properties.textSize("20") ];
              };
              throw new Error("Failed pattern match at Main line 136, column 15 - line 150, column 29: " + [ state.success.constructor.name ]);
          })())([  ]) ]), PrestoDOM_Elements.linearLayout([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(50)), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.Match_Parent.value), PrestoDOM_Properties.margin("20,70,20,20"), PrestoDOM_Properties.background("#969696"), PrestoDOM_Properties.gravity("center"), PrestoDOM_Properties.visibility("not"), PrestoDOM_Properties.name("name"), PrestoDOM_Events.onClick(action.submitClick) ])([ PrestoDOM_Elements.textView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(80)), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(25)), PrestoDOM_Properties.text("Submit"), PrestoDOM_Properties.textSize("28") ]) ]) ]) ]) ]);
      };
  };
  var main = (function () {
      var validate = function (user) {
          return function (pass) {
              return function (oldState) {
                  var $7 = Data_String.length(user) > 0 && (Data_String.length(pass) > 0 && pass === "blueberry");
                  if ($7) {
                      var $8 = {};
                      for (var $9 in oldState) {
                          if ({}.hasOwnProperty.call(oldState, $9)) {
                              $8[$9] = oldState[$9];
                          };
                      };
                      $8.errorMsg = "Welcome " + (user + "");
                      $8.success = true;
      ...
      return function __do() {
          var v = PrestoDOM_Core.mkDyn(PrestoDOM_Core.strDyn)("")();
          var v1 = PrestoDOM_Core.mkDyn(PrestoDOM_Core.strDyn)("")();
          ...
          return Control_Apply.applySecond(Control_Monad_Eff.applyEff)(v3.updateState(Control_Apply.apply(FRP_Behavior.applyABehavior(FRP_Event.functorEvent))(Control_Apply.apply(FRP_Behavior.applyABehavior(FRP_Event.functorEvent))(Data_Functor.map(FRP_Behavior.functorABehavior(FRP_Event.functorEvent))(validate)(Data_Lens_Getter.viewOn(v)(PrestoDOM_Core.beh)))(Data_Lens_Getter.viewOn(v1)(PrestoDOM_Core.beh)))(v3.stateBeh))(Data_Lens_Getter.viewOn(v2)(PrestoDOM_Core.ev)))(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))();
      };
  })();
  exports["main"] = main;
  exports["view"] = view;
